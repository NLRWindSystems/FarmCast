...
def generate_cases(n_turbines=3,
                   ...
                   domain_edge_LR = [3., 3., 3., 3., 3.], # extra spacing along x (left and right) and y (top and bottom ) and z in D
                   domain_edge_HR = [0.4, 0.4, 0.4, 0.4, 0.4], # extra spacing along x (left and right) and y (top and bottom ) and z in D
                   cmax = 5.,
